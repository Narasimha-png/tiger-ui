!(function (e, t) {
  ...
  class b {
    ...
    subscribe(e, t, r) {
      ...
      (n = (function (e, t) {
        ...
        void 0 === n.next && (n.next = v),
        void 0 === n.error && (n.error = v),
        void 0 === n.complete && (n.complete = v);
  ...
  function le(e, t = {}) {
    ...
    var n = Object.assign({ name: Q, automaticDataCollectionEnabled: !1 }, t);
    const a = n.name;
  ...
  function pe(e, t, r) {
    ...
    ie(new _(`${n}-version`, () => ({ library: n, version: t }), "VERSION"));
  }
  function ue(e, t) {
    if (null !== e && "function" != typeof e)
      throw oe.create("invalid-log-argument");
    !(function (i, e) {
      for (const t of I) {
        let a = null;
        e && e.level && (a = O[e.level]),
          (t.userLogHandler =
            null === i
              ? null
              : (e, t, ...r) => {
        ...
        { heartbeatsToSend: t, unsentEntries: r } = (function (e, t = 1024) {
          ...
          for (const a of e) {
            ...
            if (i) {
              ...
              (r.push({ agent: a.agent, dates: [a.date] }), De(r) > t)
            ) {
              r.pop();
              break;
            }
  ...
  (Z = ""),
    ie(new _("platform-logger", (e) => new Y(e), "PRIVATE")),
    ie(new _("heartbeat", (e) => new we(e), "PRIVATE")),
    pe(X, "0.9.11", Z),
    pe(X, "0.9.11", "esm2017"),
    pe("fire-js", "");
  var Se = Object.freeze({
    ...
    getApp: function (e = Q) {
      ...
      if (!t) throw oe.create("no-app", { appName: e });
      return t;
    },
    getApps: function () {
  ...
  class Oe {
    constructor(e, t) {
      (this._delegate = e),
        (this.firebase = t),
        ne(e, new _("app-compat", () => this, "PUBLIC")),
    ...
    delete() {
      return new Promise((e) => {
        ...
        () => (this.firebase.INTERNAL.removeApp(this.name), de(this._delegate))
      );
    }
    _getService(e, t = Q) {
      var r;
  ...
  function Le(a) {
    ...
    function o(e) {
      if (((e = e || Q), !u(i, e))) throw Ae.create("no-app", { appName: e });
      return i[e];
    }
    return (
      (s.default = s),
  ...
  const Te = Ne;
  pe("@firebase/app-compat", "0.2.11", void 0);
  return Te.registerVersion("firebase", "9.22.1", "app-compat-cdn"), Te;
});
