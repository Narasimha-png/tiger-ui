...
import { ProfileService, StreakData } from '../app/profile.service';
...
export class StreakComponent {
  ...
  if (!this.streakData || this.streakData.targetCommits === undefined || this.streakData.targetSubmssions === undefined) {
    return false;
  }
